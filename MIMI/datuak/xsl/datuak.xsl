...
<body>
    ...
    <main>
        ...
        <h3>Langileak</h3>
            ...
            <div class="topalbum">
                <div class="albumlist">
                    <xsl:for-each select="/langileak">
                    <a>
                        <xsl:attribute name="href"><xsl:value-of select="/langilea/argazkia/text()"></xsl:value-of></xsl:attribute>   
                        <xsl:attribute name="target"><xsl:text>_blank</xsl:text></xsl:attribute>
                        <xsl:value-of select="/langilea/izena"></xsl:value-of>
                    </a>
                    </xsl:for-each>
                </div>
            </div>
