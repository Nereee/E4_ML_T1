...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <!-- Define la variable selectedArdura -->
    <xsl:variable name="selectedArdura" select="substring-before(substring-after(concat('&amp;', substring-before($query_string, '&amp;ardurakcheckbox=')), '&amp;'), '&amp;')"/>
                    ...
                    <section>
                        <div>
                            ...
                            <form id="filtratzailea" action="" method="get">
                                <select name="ardurakcheckbox" id="ardurakcheckbox" onchange="submitForm()" class="checkbox-ak">
                                    <option value="">Aukeratu Ardura</option>
                        ...
                        <div class="langilekutxa">
                            <xsl:for-each select="langileak/langilea">
                                <xsl:if test="(ardura_id = $selectedArdura or $selectedArdura = '') and (departamentu_id = $selectedDepartamentua or $selectedDepartamentua = '')">
