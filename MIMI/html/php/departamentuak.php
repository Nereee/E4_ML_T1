...
<head>
    ...
    <link rel="stylesheet" href="../../css/departamentuak.css">
...
<body>
    ...
    <thead>
        <tr>
            <th><b>Departamentua</b></th>
            <th><b>Helbidea</b></th>
            <th><b>Mail</b></th>
            <th><b>Telefonoa</b></th>
            <th><b>Departamentu Burua</b></th>
        </tr>
    </thead>
    <tbody>
    ...
    //El error no es que no saque el nombre (eso si deberia de sacarlo) el problema es q no pilla el id.



    //Los datos q saca del xml para meterlos luego en la tabla
foreach ($xml->departamentuak->departamentua as $departamentua) {

    $izena = $departamentua->izena;
    $helbidea = $departamentua->helbidea;
    $mail = $departamentua->mail;
    $telefonoa = $departamentua->telefonoa;
    $departamentu_burua_id = $departamentua->departamentu_burua;

    //supuestamente este seria el xpath para sacar el nombre pero no saca nada
    $langile = $xml->xpath("//langilea[@idLang='{$departamentu_burua_id}']/izena");

        //Para q no me saque el error de siempre
    if (!empty($langile)) {
        $departamentu_burua_nombre = (string) $langile[0];
    } else {
        $departamentu_burua_nombre = "Langilea ez da aurkitu";
    }

    // Muestra lo q se ve en la tabla
    echo "<tr>";
    echo "<td><b>$izena</b></td>";
    echo "<td><b>{$helbidea->kalea} {$helbidea->zbk}, {$helbidea->solairu}, {$helbidea->herria}, {$helbidea->auzoa}, {$helbidea->probintzia}</b></td>";
    echo "<td><b>$mail</b></td>";
    echo "<td><b>$telefonoa</b></td>";
    echo "<td><b>$departamentu_burua_nombre</b></td>";
    echo "</tr>";
}
?>
